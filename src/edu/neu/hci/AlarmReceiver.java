...
import edu.neu.hci.R.drawable;
import edu.neu.hci.R.string;
import edu.neu.hci.alarm.Alarm;
import edu.neu.hci.alarm.AlarmAlert;
import edu.neu.hci.alarm.AlarmAlertFullScreen;
import edu.neu.hci.alarm.AlarmAlertWakeLock;
import edu.neu.hci.alarm.Alarms;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (now > alarm.time + STALE_WINDOW) {
			Log.i(DatabaseDictionary.TAG, "Ignoring stale alarm");
			return;
		}
		...
		n.setLatestEventInfo(context, label, "Snooze?", pendingNotify);
	...
	private void updateNotification(Context context, Alarm alarm, int timeout) {
		...
		Intent viewAlarm = new Intent(context, StartSleepActivity.class);
