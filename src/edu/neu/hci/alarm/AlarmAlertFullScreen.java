...
public class AlarmAlertFullScreen extends Activity {
	...
	protected void onCreate(Bundle icicle) {
		...
		final String vol = PreferenceManager.getDefaultSharedPreferences(this).getString(KEY_VOLUME_BEHAVIOR, DEFAULT_VOLUME_BEHAVIOR);
	...
	private void snooze() {
		...
		final String snooze = PreferenceManager.getDefaultSharedPreferences(this).getString(KEY_ALARM_SNOOZE, DEFAULT_SNOOZE);
